...
import static com.argosnotary.argos.service.adapter.in.rest.api.model.RestValidationMessage.TypeEnum;

public class ValidationHelper {
    private ValidationHelper() {
    }

    static void throwLayoutValidationException(TypeEnum type, String field, String message) {
