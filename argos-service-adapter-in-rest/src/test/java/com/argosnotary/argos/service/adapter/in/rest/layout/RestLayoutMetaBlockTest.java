...
import static com.argosnotary.argos.service.adapter.in.rest.ValidateHelper.ValidationError;
...
class RestLayoutMetaBlockTest {
    ...
    void emptyRestLayoutMetaBlock() {
        List<ValidationError> errors = validate(new RestLayoutMetaBlock());
    ...
    void emptySubItemsRestLayout() {
        ...
        assertThat(validate(new RestLayoutMetaBlock()
                ...
                .layout(new RestLayout()
                        ...
                        .addKeysItem(new RestPublicKey()))), contains(expectedErrors(
