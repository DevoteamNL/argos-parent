...
import static com.argosnotary.argos.service.adapter.out.mongodb.layout.ApprovalConfigurationRepositoryImpl.SEGMENT_NAME_FIELD;
import static com.argosnotary.argos.service.adapter.out.mongodb.layout.ApprovalConfigurationRepositoryImpl.STEP_NAME_FIELD;
import static com.argosnotary.argos.service.adapter.out.mongodb.layout.ApprovalConfigurationRepositoryImpl.SUPPLYCHAIN_ID_FIELD;
...
public class ApprovalConfigurationDatabaseChangelog {
    ...
    private void createCompoundIndexOnSupplyChainAndSegmentNameAndStepName(MongockTemplate template) {
